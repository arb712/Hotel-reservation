...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>HOTEL,</p>
				<p>Batu Aji,<br>Batam,<br>Kepulauan Riau.</p>
				<p>(+62)21 8564 7628</p>
			</address>
			<span><h6 style="font-size:80px;">HOTEL</h6></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
			...
			<table class="balance">
            <tr>
					<th><span >Method Payment</span></th>
					<td><span data-prefix></span><span><?php echo $mebayar; ?></span></td>
				</tr>
				<tr>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- hotel@hotel.com || Web :- www.hotel.com || Phone :- +62821 8564 7628 </p>
			</div>
		</aside>
		<br><br><br><br><br><br><br>
		------------------------------------------------------------------------------------------------------
		<br><br>
		<h4 style="font-size:30px;margin-left:300px;">Cut Here</h4>
		<br>
		<h4 style="font-size:30px;margin-left:200px;">Click Right Mouse To Print</h4>
	</body>
</html>
<?php
$free="Free";
